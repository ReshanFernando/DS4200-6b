//scatter plot code from Aditeya's tutorial and 
// https://www.d3-graph-gallery.com/graph/scatter_basic.html

// set the dimensions and margins of the graph
var svg = d3.select("#custom"),
...
d3.csv(
  ...
  function showVisMouseover(data, id) {
    ...
    function mouseout() {
      d3.select(this).style("fill", d => colors(d.source));
